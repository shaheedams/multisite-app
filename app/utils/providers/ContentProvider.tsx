...
export const ContentWrapper = ({ children }: { children: ReactNode }) => {
    ...
    const ln: string = searchParams.get("ln") || 'en';

    const [siteData, setSiteData] = useState({ brand_name: data.brand_name, data: data?.languages[ln] });

    return (
        <ContentProvider.Provider value={{ siteData, setSiteData }} >
            {children}
